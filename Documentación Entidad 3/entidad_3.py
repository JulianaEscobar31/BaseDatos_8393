...
# ID (id)
# La selección del país(seleccion)
# Status (status)
...
selecciones = ['Qatar', 'Ecuador', 'Senegal', 'Países Bajos', 'Inglaterra', 'Irán', 'USA', 'Gales', 'Argentina', 'Arabia Saudita', 'México', 'Polonia', 'Francia', 'Australia', 'Dinamarca', 'Tunez', 'España', 'Costa Rica', 'Alemania', 'Japón', 'Bélgica', 'Canada', 'Marruecos', 'Croacia', 'Brasil', 'Serbia', 'Suiza', 'Camerón', 'Portugal', 'Ghana', 'Uruguay', 'Corea del Sur']

df['seleccion'] = random.choices(selecciones, weights=(0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32,0.32), k=num_users)
...
df.to_csv('dataset_entidad3.csv')